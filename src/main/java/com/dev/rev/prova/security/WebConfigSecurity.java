...
public class WebConfigSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		http
				...
				.permitAll().antMatchers(HttpMethod.POST, APILOCAL).hasRole(ADMIN)
				.antMatchers(HttpMethod.PUT, APILOCAL).hasRole(ADMIN).antMatchers(HttpMethod.DELETE, APILOCAL)
				.hasRole(ADMIN).antMatchers(HttpMethod.PATCH, APILOCAL).hasRole(ADMIN)
